...
class CornellBoxScene : public Scene
{
  ...
  public:
    ...
    {
        std::shared_ptr<Material> light_material = std::make_shared<EmissiveMaterial>(glm::vec3(50.f, 50.f, 50.f));
        ...
        */
        ...
        glm::vec3 verts[12] = {
            ...
            glm::vec3(2.f, -2.f, -6.f), glm::vec3(2.f, 2.f, -6.f), glm::vec3(-1.f, 1.99f, -3.f),
            glm::vec3(-1.f, 1.99f, -5.f), glm::vec3(1.f, 1.99f, -5.f), glm::vec3(1.f, 1.99f, -3.f)
        };
