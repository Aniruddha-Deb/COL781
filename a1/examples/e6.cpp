...
#include <chrono>
// Clock program
// Use the same polygon and affine transformations to do this.
...
int main()
{
    ...
    vec4 vertices[] = {vec4(-0.8, -0.8, 0.0, 1.0), vec4(0.8, -0.8, 0.0, 1.0), vec4(-0.8, 0.8, 0.0, 1.0),
                       vec4(0.8, 0.8, 0.0, 1.0)};
    vec4 colors[] = {vec4(0.0, 0.4, 0.6, 1.0), vec4(1.0, 1.0, 0.4, 1.0), vec4(0.0, 0.4, 0.6, 1.0),
                     vec4(1.0, 1.0, 0.4, 1.0)};
    ivec3 triangles[] = {ivec3(0, 1, 2), ivec3(1, 2, 3)};
